/**
 * Decimen-compatible optical QR frame protocol (bit-identical layout).
 *
...
/** True if buffer starts with Decimen magic (even if incomplete). */
export function looksLikeOpticalFrame(bytes: Uint8Array): boolean {
